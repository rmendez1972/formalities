...
public class ControladorSeguimiento extends HttpServlet 
{
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
         ...
         if(operacion.equals("enviarcorreo"))
        {
          ...
          {    
            mail correo = new mail();
            resultado=correo.send(email, "Notificación de Estatus de Trámite con la SEDUVI", "<table border='0' align='center' width='90%'><tr><td><img src=\"http://189.221.153.178:4200/assets/img/headerreporte.png\" /></td></tr></table><br><b>Hola, "+nombre_solicitante +" "+apellido_paterno+" "+apellido_materno+"</b><br><br>"+"Por este medio te avisamos que tu trámite se encuentra INCONCLUSO (<b>"+nombretramite+"</b>), de fecha: "+fecha_seguimiento+" con número de folio: <b>"+id_solicitud+"</b> con las siguientes observaciones: <br>"+observaciones+"<br><br>"+"Atentamente"+"<br><br>"+"<b>"+nombreunidadadministrativa+"</b><br>Secretaría de Desarrollo Territorial Urbano Sustentable");
          }
          
          if(nombrestatus.equals("REVERTIDO"))
          {    
            mail correo = new mail();
            resultado=correo.send(email, "Notificación de Estatus de Trámite con la SEDUVI", "<table border='0' align='center' width='90%'><tr><td><img src=\"http://189.221.153.178:4200/assets/img/headerreporte.png\" /></td></tr></table><br><b>Hola, "+nombre_solicitante +" "+apellido_paterno+" "+apellido_materno+"</b><br><br>"+"Por este medio te avisamos que tu trámite se encuentra REVERTIDO(<b>"+nombretramite+"</b>), de fecha: "+fecha_seguimiento+" con número de folio: <b>"+id_solicitud+"</b> con las siguientes observaciones: <br>"+observaciones+"<br><br>"+"Atentamente"+"<br><br>"+"<b>"+nombreunidadadministrativa+"</b><br>Secretaría de Desarrollo Territorial Urbano Sustentable");
          }
